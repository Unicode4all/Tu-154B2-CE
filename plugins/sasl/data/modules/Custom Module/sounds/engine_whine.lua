...
function update()
	...
	if external == 0 then -- internal
		...
		setSampleGain(out_high_R_3, out_high_gn_3*chan_right2)
				---------- Fan rattle sounds --------------
		setSampleGain(rattle_L_1, ratl_1_L*rattle_gn_1*chan_left2*0.7)
		setSampleGain(rattle_R_1, ratl_1_R*rattle_gn_1*chan_right2*0.7)
		setSamplePitch(rattle_L_1,rattle_pitch_1)
		setSamplePitch(rattle_R_1,rattle_pitch_1)
		setSampleGain(rattle_L_3, ratl_3_L*rattle_gn_3*chan_left2*0.7)
		setSampleGain(rattle_R_3, ratl_3_R*rattle_gn_3*chan_right2*0.7)
